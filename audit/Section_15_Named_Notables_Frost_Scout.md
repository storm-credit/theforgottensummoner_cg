...
프로스트 역할 슬롯은 `Section_15_Frost_Place_Institution_Sidecar.md`에 연결한다.

요약:

- `오로라 평원`: 전승 보존회 원로 사냥꾼 / 대예언자 / 별의 샤먼
- `얼음무덤 언덕`: 묘지기 장로
- `푸른 폭풍 요새`: 수석 기술자 / 드워프 장인
- `퍼마프로스트 요새`: 시그리드 / 공성단
- `아이스포지 병기소`: 아이스포지 병기소 장인
- `빙하의 성소`: 마리안 / 울프릭 / 주술사 원로단

판정:

- 새 이름을 만들지 않는다.
- 역할 슬롯과 장소 기능만 먼저 보강한다.
