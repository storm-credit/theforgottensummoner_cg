...
## Next Expansion Groups

다음으로 자연스럽게 늘어날 후보 묶음:
...
- 새 후보가 생기면 먼저 `Group Index`에 올린다.
- 그다음 `Group Draft`를 만든다.
- 그 다음에야 `개별 Profile Template`로 내린다.
- 계열 시트가 충분히 쌓이면
  `Subline Draft`로 다시 쪼개서 장기 확장 포인트를 고정한다.
