...
|---|---|---|---|
| `전승 보존회 원로 사냥꾼` | `slot_with_display_candidate` | `서리길 원로 사냥꾼` | 실제 개인명 확인 |
| `묘지기 장로` | `slot_with_display_candidate` | `빙묘 수호장` | 기록/묘역 인명 확인 |
| `대예언자` | `slot_with_display_candidate` | `오로라 예언장` | 예언 지도부 실명 확인 |
| `수석 기술자 / 드워프 장인` | `slot_with_display_candidate` | `빙철 공방장` | 공방/병기 장인 실명 확인 |
| `별의 샤먼` | `slot_with_display_candidate` | `오로라 별술사` | 샤먼/주술사 실명 확인 |
| `아이스포지 병기소 장인` | `slot_with_display_candidate` | `서리벼림 장인` | 병기소 장인 실명 확인 |
