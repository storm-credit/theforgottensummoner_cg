...
| 벨라나 스톰브링어 | `named_notable_candidate` | 현자 회의 / 주술사 / 고고학자 |
| 아리안 블레이즈하트 | `named_notable_candidate` | 현자 회의 / 전승 보존자 |
...
| 벨라나 스톰브링어 | `15 / 크림슨 / 붉은 사막 부족 / 현자 회의` | `주술사`, `사제`, `고고학자` | `route_test_ok_with_more_context` |
| 아리안 블레이즈하트 | `15 / 크림슨 / 붉은 사막 부족 / 현자 회의` | `전승 보존자`, `사제`, `현자` | `route_test_ok_with_more_context` |
...
2. `벨라나`, `아리안`은 현자 회의 근거를 더 보강한 뒤 시트화한다.
