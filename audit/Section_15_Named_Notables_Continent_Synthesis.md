...
이 문서는 `15번 Named Notables`를 대륙별로 종합한 현재 판정표다.
...
- `need_named_candidate` 슬롯은 나중에 원본 문서에서 근거를 찾은 뒤 채운다.
...
| 벨라나 스톰브링어 | `15 candidate` | 현장 명사층 후보. |
| 아리안 블레이즈하트 | `15 candidate` | 현장 명사층 후보. |
...
다만 드락사르와 카사르는 먼저 14번 경계 검증을 통과해야 한다.
...
에테르는 세계관 중심성이 높으므로 다음 우선 스카우트 대상이다.
먼저 마법협회와 성국의 비영웅 명사층을 찾는다.
...
범대륙은 후기 확장 구역이다.
강한 후보라도 현재 메인 정리의 중심축으로 끌어올리지 않는다.
