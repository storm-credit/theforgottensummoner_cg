...
|---|---|---|---|
| `울프가르 드래곤포지` | `15 / 크림슨 / 용의 후예 / 드래곤포지 공방` | `draft_route_ready` | 용의 대장장이/공방주. 장소와 조직 앵커가 분명하다. |
| `에리온 드라코비스` | `15 / 크림슨 / 엘드라칸 / 학술-전승층` | `draft_route_ready` | 고대어 해석가/대현자. 엘드라칸 학술 축에 둔다. |
| `오그마` | `15 / 크림슨 / 엘드라칸 / 용언 도서관 또는 전승 보관층` | `draft_route_ready` | 살아있는 도서관/고룡 조언자. 장소 세부명은 후속 확인. |
...
다음 실작업은 이 라우팅 계획을 바탕으로
`15번 실제 폴더 초안 구조`를 문서로만 그리는 것이다.
