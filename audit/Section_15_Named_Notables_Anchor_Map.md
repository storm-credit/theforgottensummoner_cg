...
- `범대륙 / 후기 확장` 후보는 키르케 계열이지만, 범대륙 자체가 후순위라 `deferred_expansion_hold / hold reference split` reference로만 남긴다.
...
1. stable 15 triad의 `stable_triad_frozen_reference_set` 문구를 중앙 앵커맵까지 동일하게 유지
